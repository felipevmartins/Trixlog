...
<script type="text/javascript" src="<fmt:message key="app.url.static"/>js/custom.js"></script>
...
<body>
	...
	<div class="list-group col-xs-5 col-sm-5 col-md-5 col-lg-5 lista-locations">
		<ul>
			<li class="list-group-item active"> Lista de Locations Alteraveis</li>
			<c:forEach var="location" items="${listaLocations}">
			<a onclick="clicaalterarlocation(${location.id});" class="list-group-item link-lista-item">
				<c:out value="${location.name }"></c:out>
			</a>
		</c:forEach>
		</ul>
	</div>
	<div id="alterar-location" class="alterar col-xs-6 col-sm-6 col-md-6 col-lg-6 hidden">
		<form role="form" id="alterar-location-form" class="col-lg-6 cadatro-locations" method="post" action="">
			<div class="form-group col-lg-12">
				...
				<button type="button" class="btn btn-default" id="btn-alterar-location">Alterar</button>
				<button type="button" class="btn btn-default" id="btn-deletar-location">Deletar</button>
		</form>
	</div>
</body>
</html>